...
import com.example.myapplication.friendlist.GroupMembersList;
...
//        tvGroupFriend4Name.setText();
        tvGroupDetailNum.setText("共"+group.getMembersNum()+"人");
        if(group.getMembersNum() == 1){
            tvGroupFriend1Name.setText(group.getMembersId().get(1));
            ...
            tvGroupFriend1Name.setText(group.getMembersId().get(1));
            tvGroupFriend2Name.setText(group.getMembersId().get(2));
            tvGroupFriend3Name.setVisibility(View.INVISIBLE);
            tvGroupFriend4Name.setVisibility(View.INVISIBLE);
            ivGroupFriend3Head.setVisibility(View.INVISIBLE);
            ivGroupFriend4Head.setVisibility(View.INVISIBLE);
        }else if(group.getMembersNum() == 3){
            tvGroupFriend1Name.setText(group.getMembersId().get(1));
            tvGroupFriend2Name.setText(group.getMembersId().get(2));
            tvGroupFriend3Name.setText(group.getMembersId().get(3));
            tvGroupFriend4Name.setVisibility(View.INVISIBLE);
            ivGroupFriend4Head.setVisibility(View.INVISIBLE);
        }else{
            tvGroupFriend1Name.setText(group.getMembersId().get(1));
            tvGroupFriend2Name.setText(group.getMembersId().get(2));
            tvGroupFriend3Name.setText(group.getMembersId().get(3));
            tvGroupFriend4Name.setText(group.getMembersId().get(4));
        }
